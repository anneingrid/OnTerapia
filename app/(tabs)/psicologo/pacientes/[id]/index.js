...
const SessionCard = ({ date, time, completed }) => {
  return (
    <Link href={'psicologo/sessao'} asChild>
        ...
        <View style={styles.iconeContainer}>
          ...
          <View style={styles.iconeItem}>
            <TouchableOpacity style={styles.iconeCirculoBorda}>
              ...
              <Badge style={styles.badgeEstilizado}>2</Badge>
            </TouchableOpacity>
...
const styles = StyleSheet.create({
  ...
  badgeEstilizado: {
    ...
    top: -5,
    right: -5,
    backgroundColor: "#477bde", // Ajusta a cor se quiser outra
    fontSize: 10,
    paddingHorizontal: 6,
    paddingVertical: 2,
    borderRadius: 10,
